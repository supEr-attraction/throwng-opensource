...
import "@styles/game/RhythmSuccessPage.scss";
...
const RhythmSuccessPage = () => {
  const [isOpen, setIsOpen] = useState<boolean>(false);
  const navigate = useNavigate();

  useEffect(() => {
    const scoreAchieved = sessionStorage.getItem("scoreAchieved") || "false";  // 초기 값 설정
...
export default RhythmSuccessPage;
